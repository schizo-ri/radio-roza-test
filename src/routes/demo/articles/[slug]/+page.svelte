<script>
  import ArticleView from '$lib/components/demo/ArticleView.svelte';
...
<div class="article-page">
  ...
  <nav class="breadcrumb" aria-label="Breadcrumb">
    <ol>
      <li><a href="/demo/articles">Articles</a></li>
      {#if article}
        <li>
          <a href="/demo/articles?category={article.category.slug}">{article.category.name}</a>
        </li>
      ...
      <div class="related-articles">
        {#each relatedArticles as relatedArticle (relatedArticle.id)}
          <div class="related-card">
            <h3>
              <a href="/demo/articles/{relatedArticle.slug}">
  ...
  <div class="navigation-footer">
    <a href="/demo/articles" class="back-link"> ← Back to All Articles </a>
  </div>
</div>
